(function (app) {
    ...
    function displayLoanHeader(
        ...
        const headerMonthlyPayment = displayHeader.querySelector('#monthlyPayment');
        const headerTotalPrincipal = displayHeader.querySelector('#totalPrincipal');
        const headerTotalInterest = displayHeader.querySelector('#totalInterest');
        const headerTotalCost = displayHeader.querySelector('#totalCost');
